...
<div class="card" style="max-width: 560px;">
  <div class="card-body p-4">
    ...
    <form method="post" action="<?= base_url('users/password.php?id=' . $id) ?>" autocomplete="off">
      ...
      <div class="mb-4">
        <label class="form-label" for="password_confirm">Confirm New Password <span class="text-danger">*</span></label>
      ...
      <div class="d-flex gap-2">
        <button class="btn btn-bb" type="submit"><i class="bi bi-key"></i> Set New Password</button>
